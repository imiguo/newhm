...
@section('content')
    <div class="panel panel-default" style="width: 80%; margin: auto">
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="/packages/{{ $package->id }}/plan" method="POST">
                {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('min') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="min" type="number" class="form-control" name="min" value="{{ old('min') }}" required autofocus>
                ...
                <div class="form-group{{ $errors->has('max') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="max" type="number" class="form-control" name="max" value="{{ old('max') }}" required autofocus>
                ...
                <div class="form-group{{ $errors->has('percent') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="percent" type="number" class="form-control" name="percent" value="{{ old('percent') ?: 0 }}" required autofocus>
